...
export default function Home({ homeData, galleryData }) {
  ...
  return (
    ...
    >
      ...
      {splitSection && <SplitSection sections={splitSection} />}
      {imgSection && <PhotoSection data={imgSection} />}
      {delivery && <CircleList data={delivery} id="delivery" />}
      {garageSubstrate && (
      ...
      {prepareGarage && <CardsSection data={prepareGarage} />}
